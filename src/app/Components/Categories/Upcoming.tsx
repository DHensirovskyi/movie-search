...
export default async function Upcoming({searchParams} : {searchParams: {query: string}}) {
    ...
    return (
      <>
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0.5rem 2rem'}}>
            <p style={{color: 'white', fontWeight: '800', fontSize: '24px'}}>  {query ? query.charAt(0).toUpperCase() + query.slice(1) : 'Upcoming'}</p>
